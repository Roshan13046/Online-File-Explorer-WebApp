...
const respond = (request, response) => {
    //    response.write('Roshan respond fired');
    //    response.end();
    // console.log('roshan fired up');
    ...
    //get the corrresponding full static path located in the static folder
    ...
    getMimeType(fileDetails.extname).then(mime => {
            ...
            //get the file size and add it to the response header         //pdf file? -> display in browser                
